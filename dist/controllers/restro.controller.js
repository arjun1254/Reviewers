...
const create = async (req, res, next) => {
    try {
        const data = await restroService.createRestaurant(req.body);
        res.json(data);
    }
    catch (err) {
        next(err);
...
const findByID = async (req, res, next) => {
    try {
        const data = await restroService.findrestaurantById(Number(req.params.id));
        res.json(data);
    }
    catch (err) {
        next(err);
...
const updateByID = async (req, res, next) => {
    try {
        ...
        const post = await restroService.updateRestaurantById(Number(id), req.body);
...
const deleteById = async (req, res, next) => {
    try {
        const { id } = req.params;
        // @TODO: Handle errors
        const post = await restroService.deleteById(Number(id));
